<?php
    ...
    if(isset($users[$username]) && $users[$username]['pwd'] === substr($password_hash, 28)) {
        $_SESSION['session_id'] = '20A61438-3837-47BB-B10A-EAFB20EDAD8A';
        ...
        header('Location: privacy-policy.html?err=99');
    }
